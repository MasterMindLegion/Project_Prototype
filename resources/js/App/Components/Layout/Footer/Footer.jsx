        ...
        <div className="container">
          <div className="row">
              ...
              <div className="col-lg-3">
                ...
                <p className="text-uppercase"><strong>E-Market Czech Republic</strong><br/>Taborska 4 <br/>Praha 6 <br/>166 36 <br/><strong>Czech Republic</strong></p><a href="contact.html" className="btn btn-template-main">Go to contact page</a>
                <hr className="d-block d-lg-none"/>
              </div>
            <div className="col-lg-3">
